...
inclusion_data = readxl::read_excel(path = 'Data/Time_events_16_01_2023_REVISED_MM_WS_Latest_FINAL_19_01_23.xlsx')
...
xx=table(`Al least one work day lost`=days_lost$days_lost>0, Arm=days_lost$treatment)
print(xx)
```
