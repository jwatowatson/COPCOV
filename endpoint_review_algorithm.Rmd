---
title: "COP CoV serological endpoint review"
...
```{r}
df_raw = read_excel("Endpoint_review_06_12_2022_latest.xlsx")
```
...
# Final check
Serum outcomes only with serum available, DBS outcomes only with DBS and no serum
```{r}
df %>% count(outcome_possible, outcome, serum_available, dbs_available) %>% 
  knitr::kable()
```
